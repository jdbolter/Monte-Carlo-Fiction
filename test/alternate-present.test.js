...
function sampleContent() {
  return {
    ...
    timeline: [
      ...
      { id: 'e8', year: 2026, development: 'Realm governance becomes a public controversy.', consequence: 'A mature but contested spatial web emerges.', causedBy: ['e7'], status: 'invented', sourceRefs: [] }
    ],
    present: {
...
test('render request receives canon and optional direction but no generation provenance or story seeds', () => {
  ...
  assert.equal(payload.timeline.length, 8);
