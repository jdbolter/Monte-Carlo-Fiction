...
| s1-012 | 2 | sensory_register=proprioceptive (was audiovisual); literacy_floor=read-only (was read+type) |  |  |
| s1-013 | 1 | address=posthumous (was broadcast-to-strangers) |  |  |
| s1-014 | 1 | literacy_floor=none (was read+type) |  |  |
| s1-015 | 1 | resemblance=realist (was photorealist) |  |  |
| s1-016 | 1 | attention_unit=household (was solitary) |  |  |
| s1-017 | 1 | address=kin-only (was broadcast-to-strangers) |  |  |
| s1-018 | 2 | resemblance=stylized (was photorealist); address=posthumous (was broadcast-to-strangers) |  |  |
| s1-019 | 2 | custody=personal-possession (was remote-tenancy); compulsion=initiatory (was optional-but-compulsory-in-fact) |  |  |
| s1-020 | 1 | compulsion=initiatory (was optional-but-compulsory-in-fact) |  |  |
| s1-021 | 2 | authorship_distribution=universal (was professional-caste); address=addressed-to-nonhumans (was broadcast-to-strangers) |  |  |
| s1-022 | 2 | address=commissioned-by-patron (was broadcast-to-strangers); literacy_floor=perform-from-memory (was read+type) |  |  |
| s1-023 | 2 | sensory_register=proprioceptive (was audiovisual); provisioning=patronage (was advertising-funded) |  |  |
| s1-024 | 2 | resemblance=cartoon (was photorealist); custody=civic-archive (was remote-tenancy) |  |  |
| s1-025 | 1 | fidelity_criterion=to-felt-truth (was optical+index-welded) |  |  |
| s1-026 | 1 | resemblance=realist (was photorealist) |  |  |
| s1-027 | 1 | fidelity_criterion=to-function (was optical+index-welded) |  |  |
| s1-028 | 1 | authorship_distribution=universal (was professional-caste) |  |  |
| s1-029 | 1 | resemblance=hyperreal (was photorealist) |  |  |
